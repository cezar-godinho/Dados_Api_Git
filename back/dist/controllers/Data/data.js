...
var DataController = /** @class */ (function (_super) {
    ...
    DataController.prototype.read = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var dadosBd, dados;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        dadosBd = sqlite.run("SELECT * FROM dados");
                        return [4 /*yield*/, sqlite.run("SELECT id, nome, count(nome) as commits, sum(inserts) as inserts, sum(deletions) as deletions from dados group by nome")];
                    case 1:
                        dados = _a.sent();
